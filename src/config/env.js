...
const env = {
  ...
  audioProcessingAsync: process.env.AUDIO_PROCESSING_ASYNC === 'true',
  audioQueueAttempts: Number(process.env.AUDIO_QUEUE_ATTEMPTS || 3),
  ...
  audioTargetBitrateKbps: Number(process.env.AUDIO_TARGET_BITRATE_KBPS || 128),
  audioVbrQuality: Number(process.env.AUDIO_VBR_QUALITY || 2),
  audioLoudnorm: process.env.AUDIO_LOUDNORM !== 'false',
  audioMaxDurationSeconds: Number(process.env.AUDIO_MAX_DURATION_SECONDS || 0),
  spacesEnabled: process.env.SPACES_ENABLED === 'true',
  spacesEndpoint: process.env.SPACES_ENDPOINT || null,
  spacesRegion: process.env.SPACES_REGION || null,
  spacesBucket: process.env.SPACES_BUCKET || null,
  spacesAccessKeyId: process.env.SPACES_ACCESS_KEY_ID || null,
  spacesSecretAccessKey: process.env.SPACES_SECRET_ACCESS_KEY || null,
  spacesPublicBaseUrl: process.env.SPACES_PUBLIC_BASE_URL || null,
  virusScanEnabled: process.env.VIRUS_SCAN_ENABLED === 'true',
  virusScanAuto: process.env.VIRUS_SCAN_AUTO !== 'false',
